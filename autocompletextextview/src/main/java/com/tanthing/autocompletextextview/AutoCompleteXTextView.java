...
package com.tanthing.autocompletextextview;
...
import com.tootoo.autocompletextextview.R;
 ...
 * </p>
 */
public class AutoCompleteXTextView extends AutoCompleteTextView implements
                                                                   View.OnTouchListener,
                                                                   View.OnFocusChangeListener {

    private static final String TAG = AutoCompleteXTextView.class.getName();
    ...
    public AutoCompleteXTextView(Context context) {
        super(context);
        init(context, null, 0);
    }

    public AutoCompleteXTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public AutoCompleteXTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            final TypedArray a = context.obtainStyledAttributes(attrs,
                                                                R.styleable.AutoCompleteXTextView,
                                                                defStyle,
                                                                0);

            mClearButtonEnabled = a.getBoolean(R.styleable.AutoCompleteXTextView_setClearButtonEnabled,
                                               true);
            mClearButtonResId = a.getResourceId(R.styleable.AutoCompleteXTextView_clearButtonDrawable,
        ...
        emailsList.add(" aaaaa");
        emailsList.add(" asdca");emailsList.add(" asdasd");emailsList.add(" 啊下吧");
        emailsList.add(" 啊啊啊");emailsList.add(" 啊阿萨德");
        ...
        setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_FLAG_AUTO_COMPLETE);
        setThreshold(0);
    ...
    @Override public void onFocusChange(View v, boolean hasFocus) {
        ...
        final AutoCompleteXTextView editText = (AutoCompleteXTextView) v;
        if (mClearButtonEnabled) {
    ...
    public static final class DefaultClearButtonClickListener implements OnClearClicked {
        ...
        private final AutoCompleteXTextView editTextPlus;

        public DefaultClearButtonClickListener(AutoCompleteXTextView editTextPlus) {
    ...
    public static final class DefaultTextChangedListener implements TextWatcher {
        ...
        public DefaultTextChangedListener(AutoCompleteXTextView editTextPlus) {
            this.editTextPlus = editTextPlus;
        }
